"""Step 0.5 — 归正骨架位置: back up, set origin under the upper body, clear animation."""
...
class OBJECT_OT_correct_bones(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        if not upper_body_bone_name:
            ...
            return {'CANCELLED'}
        if not obj.pose.bones.get(upper_body_bone_name):
        ...
        # Target origin (world): X of the upper body, Y/Z = 0.
